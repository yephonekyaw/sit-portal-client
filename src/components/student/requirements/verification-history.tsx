...
//         history.old_status.toLowerCase() as keyof typeof SUBMISSION_STATUS_CONFIGS
//       ];
//     const newStatusConfig =
//       SUBMISSION_STATUS_CONFIGS[
//         history.new_status.toLowerCase() as keyof typeof SUBMISSION_STATUS_CONFIGS
//       ];
...
//   if (!verificationHistories.length) {
//     return (
