      ...
      <div className="flex items-center gap-3">
        <Drawer open={open} onOpenChange={setOpen}>
          ...
          <DrawerContent className="min-h-[80vh] px-4 pb-6">
            ...
            <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 overflow-y-auto">
                  ...
                  breakdowns={[
                    {
                      ...
                      percentage:
                        stats.submitted_count > 0
                          ? (stats.approved_count / stats.submitted_count) * 100
                          : 0,
                    },
                    {
                      label: "Pending",
                      ...
                      percentage:
                        stats.submitted_count > 0
                          ? (stats.pending_count / stats.submitted_count) * 100
                          : 0,
                    },
                    {
                      label: "Rejected",
                      ...
                      percentage:
                        stats.submitted_count > 0
                          ? (stats.rejected_count / stats.submitted_count) * 100
                          : 0,
                    },
                    {
                      label: "Manual Review",
                ...
                <StatCard
                  ...
                  breakdowns={[
                    ...
                    },
                    {
                      ...
                      percentage:
                        totalTimingSubmissions > 0
                          ? (stats.late_submissions / totalTimingSubmissions) *
                            100
                          : 0,
                    },
                    {
                      ...
                      percentage:
                        totalTimingSubmissions > 0
                          ? (stats.overdue_count / totalTimingSubmissions) * 100
                          : 0,
                    },
                  ]}
